...
This will demonstrate how to export a document library to excel with a Version Number as a column.

![export]({{ site.url }}{{ site.baseurl }}/_posts/vba/images/sharepoint-to-excel-with-version.jpg){: .align-right}
